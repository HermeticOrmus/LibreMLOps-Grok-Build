...
Ports from LibreMLOps-Claude-Code must follow Liquid Gold:

1. Keep model-agnostic MLOps knowledge.
...
5. Do not invent metrics, SLOs, or significance claims.
...
- No invented metrics. Mark unverified instead.
